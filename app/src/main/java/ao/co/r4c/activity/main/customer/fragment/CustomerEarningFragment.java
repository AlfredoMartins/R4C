...
public class CustomerEarningFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_earning_customer, container, false);
    ...
    private void readEarnData() {
        ...
        /*Call the interface*/
        Call<Embolso> embolsoCall = apiInterface.carregarEmbolsoPassageiro(user_id);
    ...
    private void readEarnUsers() {
        ...
        /*Call the interface*/
        Call<ArrayList<Viagem>> listCall = apiInterface.listarHistoricoViagensPassageiro(user_id);
