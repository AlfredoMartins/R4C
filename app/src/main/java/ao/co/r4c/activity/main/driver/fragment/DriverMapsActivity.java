...
import static ao.co.r4c.activity.main.driver.fragment.DriverHomeFragment.supportMapFragment;
...
import ao.co.r4c.activity.main.customer.fragment.CustomerChatFragment;
...
public class DriverMapsActivity extends AppCompatActivity
    ...
    DriverRantingsFragment driverRantingsFragment;
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                    ...
                    switch (menuItem.getItemId()) {
                        case R.id.nav_home:
                            ...
                            ShowFragment(driverHomeFragment);

                            break;

                        case R.id.nav_embolso:
                            ShowFragment(driverEarningFragment);
                            if (supportMapFragment.isResumed())
                        ...
                        case R.id.nav_favoritos:
                            ShowFragment(driverRantingsFragment);
                            if (supportMapFragment.isResumed())
                                supportMapFragment.onPause();
                            break;
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startService(new Intent(DriverMapsActivity.this, onAppKilled.class));
        ...
        try {
            ...
            driverEarningFragment = new DriverEarningFragment();
            driverNewsFragment = new DriverNewsFragment();
            customerChatFragment = new CustomerChatFragment();
            driverRantingsFragment = new DriverRantingsFragment();
                ...
                .setOnDragStateChangedListener(new Badge.OnDragStateChangedListener() {
                    ...
                    public void onDragStateChanged(int dragState, Badge badge, View targetView) {
                        if (Badge.OnDragStateChangedListener.STATE_SUCCEED == dragState)
                            Toast.makeText(DriverMapsActivity.this, "Badge removed", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_update_profile) {
            ...
            intent = new Intent(DriverMapsActivity.this, UserProfileActivity.class);
            startActivity(intent);
            ...
            try {
                intent = new Intent(DriverMapsActivity.this, TripsActivity.class);
                startActivity(intent);
            ...
            intent = new Intent(DriverMapsActivity.this, AboutActivity.class);
            startActivity(intent);
            ...
            intent = new Intent(DriverMapsActivity.this, LoginActivity.class);
