...
if($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    $viagem->setId($_POST['id_viagem']);
    $viagem->setPreco($_POST['id_avaliacao']);

    //If sucess has sucess
    if ($viagem->avaliar_viagem()) {
        ...
        $data = array(
            "status" => true,
            "message" => "Viagem avaliada com sucesso.",
        );
    } else {
        ...
        $data = array(
            "status" => false,
            "message" => "Erro ao avaliar viagem.",
        );
    }
