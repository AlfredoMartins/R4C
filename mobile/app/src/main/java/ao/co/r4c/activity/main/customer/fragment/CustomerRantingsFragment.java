...
public class CustomerRantingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_rantings_customer, container, false);
    ...
    private void readRantingData() {
        ...
        /*Call the interface*/
        Call<Estatistica> embolsoCall = apiInterface.dadosEstatisticosPassageiro(user_id);
    ...
    private void readCommentsUsers() {
        ...
        try {
            ...
            for (int i = 0; i < 20; i++)
                userItemList.add(new UserCommentItem(
                        i,
                        "Alfredo",
                        "10h:30min 27/07/2019",
                        "Os tipos mais comuns de cabos de rede são coaxial, par trançado e fibra óptica. O coaxial está sendo descontinuado em redes locais. O mais usado hoje é o d0 tipo par trançado.",
                        4
                ));
    ...
    private void readComments() {
        ...
        /*Call the interface*/
        Call<ArrayList<Comentario>> listCall = apiInterface.carregar_comentarios_passageiro(user_id);
